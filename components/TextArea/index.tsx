  ...
  return (
    <div className="w-full relative">
      <textarea
        ...
        className={cn(
          "peer w-full p-4 pt-6 max-h-[150px] min-h-[150px] min outline-none bg-shop-input-bg font-light border-2 rounded-md transition disabled:opacity-70 disabled:cursor-not-allowed",
          errors[id]
            ? "border-rose-400 focus:border-rose-400 text-rose-500"
            : "border-shop-text-border focus:border-shop-text-border text-shop-input-text"
        )}
      />
      <label
        htmlFor={id}
