  ...
  return (
    <div className="w-full relative">
      <textarea
        ...
        className={cn(
          "peer w-full p-4 pt-6 max-h-[150px] min-h-[150px] min outline-none bg-shop-input font-light border-2 rounded-md transition disabled:opacity-70 disabled:cursor-not-allowed",
          errors[id]
